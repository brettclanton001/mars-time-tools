class MarsClock {
        ...
        constructor(earthDatetime) {
                this.earthDatetime = earthDatetime;
        }

        // Get Mars Sol Date
        getMSD() {
                var earthUnixTimeInMilliseconds = this.earthDatetime;
...
console.log(marsClock.getMSD());
console.log(marsClock.getMTC());
